...
let answers = [36.9,16.3,43.6,22.6,106.3,61.9,46.4,45.2,92.8,36.9];

let problem_directions = "Find the missing of the indicated angle. Round to the nearest tenth degree."
const problem_list = [];
