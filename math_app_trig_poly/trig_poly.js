...
let answers = [41.6,32.7,232.6,93.5,43.5,27.7,6.9,130.8,15.5,166.3];

let problem_directions = "Find the area of each regular polygon.  Round answer to nearest tenth."
const problem_list = [];
